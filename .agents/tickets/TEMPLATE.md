# [TICK-XXX]: Título Descriptivo de la Tarea o Feature
...
- **ID**: `TICK-XXX`
- **Estado Actual**: `DRAFT` <!-- Opciones: DRAFT | READY_FOR_DEV | IN_DEVELOPMENT | READY_FOR_QA | QA_VERIFIED | REJECTED | CLOSED -->
- **Persona Asignada**: `analista` <!-- Opciones: analista | desarrollador | qa | gitflow -->
- **Rama Asociada**: `feature/<nombre-de-la-rama>`
